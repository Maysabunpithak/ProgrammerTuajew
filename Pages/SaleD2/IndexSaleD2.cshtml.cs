...
{
    public class IndexSaleD2Model : PageModel
    {
        public List<SaleD2Info> InboxList = new List<SaleD2Info>();
        public List<SaleD2Info> SentList = new List<SaleD2Info>();
        ...
        public void OnGet()
        {
            ...
            try
            {
                ...
                using (SqlConnection connection = new SqlConnection(connectionString))
                {
                    ...
                    if (View == "inbox")
                    {
                        string inboxSql = "SELECT * FROM SaleD1 WHERE ReceiverDepartment = 'SaleD2'";
                        using (SqlCommand command = new SqlCommand(inboxSql, connection))
                        {
                            using (SqlDataReader reader = command.ExecuteReader())
                            {
                                while (reader.Read())
                                {
                                    SaleD2Info email = new SaleD2Info
                                    {
                    ...
                    {
                        string sentSql = "SELECT * FROM SaleD1 WHERE SenderDepartment = 'SaleD2'";
