...
{
    public class IndexSaleD3Model : PageModel
    {
        public List<SaleD3Info> InboxList = new List<SaleD3Info>();
        public List<SaleD3Info> SentList = new List<SaleD3Info>();
                    ...
                    if (View == "inbox")
                    {
                        ...
                        using (SqlCommand command = new SqlCommand(inboxSql, connection))
                        {
                            using (SqlDataReader reader = command.ExecuteReader())
                            {
                                while (reader.Read())
                                {
                                    SaleD3Info email = new SaleD3Info
                                    {
